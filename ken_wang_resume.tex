...
\item Also know basic Python data analysis and JavaScript with Node.js development.
\end{skillSection}
...
\item MySQL, Postgres, Redis, Linux, Docker, AWS, Git, Hadoop
\item Python, JavaScript, Node.js, NumPy, pandas, scikit-learn, PyTorch
\end{skillSection}
