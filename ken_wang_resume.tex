...
\item 3 years experience in Java backend development. Familiar with Spring Cloud microservices.
\item Plus experience in Python data analysis and JavaScript with Node.js/React development.
\end{skillSection}
...
\item Java, Spring Boot, Spring Cloud, MySQL, Postgres, Redis, Linux, Docker, Tomcat, JUnit, Mockito, Hibernate, Maven, Git, AWS, Hadoop, JavaScript, Node.js, React, Python, pandas, scikit-learn, PyTorch
\end{skillSection}
